...
def kb13(id) -> InlineKeyboardMarkup:
...
def kb12(id) -> InlineKeyboardMarkup:
    buttons_list = list()
...
def kb11(id, category) -> InlineKeyboardMarkup:
    buttons_list = list()
...
def kb14(id) -> InlineKeyboardMarkup:
